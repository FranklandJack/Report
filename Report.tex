  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \begin{tikzpicture}[scale=1.2]
                            \begin{axis}[
                                ...
                                table[x index=0, y index=1]{DataForReport/1001ConfigurationEvolution1.dat};
                                \addplot[color=red,mark=none,]
                                table[x index=0, y index=1]{DataForReport/1001ConfigurationEvolution2.dat};
                                \addplot[color=blue,mark=none,]
                                table[x index=0, y index=1]{DataForReport/1001ConfigurationEvolution3.dat};


                            \end{axis}
                        \end{tikzpicture}
                        \caption{Evolution of the configuration with initial configuration in green, after 100 leapfrog steps in red and at the end of the trajectory in blue.}
  \end{subfigure} 
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \begin{tikzpicture}[scale=1.2]
                            \begin{axis}[
                                ...
                                \addplot[color=green,mark=none,]
                                table[x index=0, y index=1]{DataForReport/101ConfigurationEvolution1.dat};
                                \addplot[color=red,mark=none,]
                                table[x index=0, y index=1]{DataForReport/101ConfigurationEvolution2.dat};
                                \addplot[color=blue,mark=none,]
                                table[x index=0, y index=1]{DataForReport/101ConfigurationEvolution3.dat};
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \begin{tikzpicture}[scale=1.2]
                            \begin{axis}[
                                ...
                                \addplot[color=green,mark=none,]
                                table[x index=0, y index=1]{DataForReport/105ConfigurationEvolution1.dat};
                                \addplot[color=red,mark=none,]
                                table[x index=0, y index=1]{DataForReport/105ConfigurationEvolution2.dat};
                                \addplot[color=blue,mark=none,]
                                table[x index=0, y index=1]{DataForReport/105ConfigurationEvolution3.dat};
