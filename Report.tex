...
\section{Results and Discussion}
    ...
    \begin{figure}
                    ...
                    \begin{subfigure}[b]{0.5\textwidth}
                        ...
                        \vspace{4ex}
                    \end{subfigure}
                    \caption{Typical first equilibrium configuration in \textcolor{green}{green} and final configuration in \textcolor{red}{red} for anharmonic oscillator at a range of $f^2$ values on a lattice of $100$ sites at a spacing of $1$.}
        ...
        \begin{figure}
                    ...
                    \end{tikzpicture}
                        ...
                        \vspace{4ex}
                    \end{subfigure}
                    \caption{Typical first equilibrium configuration in green and final configuration in red for anharmonic oscillator at a range of $f^2$ values on a lattice of $100$ sites at a spacing of $1$.}
                    \label{fig:IntialFinalConfigurations}
                \end{figure}
