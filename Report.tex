...
\section{Results and Discussion}
        ...
        \subsubsection{Quantum Harmonic Oscillator}
            ...
            \paragraph{Mean Square Position}
                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}[scale=1.5]
                        ...
                        \end{axis}
                    \end{tikzpicture}
                    \caption{Relationship between lattice spacing and expectation of position squared for the harmonic oscillator with $\mu^2 = 1, m = 1$. Measurements were made on a $N=100$ site lattice for a range of lattice spacings $a$.}
            ...
            \paragraph{Energy Levels}
                ...
                \begin{tikzpicture}[scale=1.5]
                            ...
                            \end{axis}
                        \end{tikzpicture}
                \caption{Ground state energies for the harmonic oscillator with $\mu^2 = 1, m = 1$ on a lattice of $N=100$ sites for a range of lattice spacings $a$.}
                ...
                \begin{figure}
                        ...
                        \begin{tikzpicture}[scale=0.7]
                            \begin{axis}[
                                ...
                                \addplot[only marks, 
                                    ...
                                    table[x index=0, 
                                        y index=1, 
                                        y error index=2]{DataForReport/HarmonicCorrelationFunction3.dat};
                            \end{axis}
                        \end{tikzpicture}
                    ...
                    \begin{subfigure}[b]{0.4\textwidth}
                        ...
                        \label{fig:LogHarmonicCorrelationFunction}
                    \end{subfigure}
                    \caption{Correlation between lattice site variables as function of their separation $j$ for the harmonic oscillator with $m=1$, $\mu=1$ on a $N=1000$ site lattice at spacing $a=1$.}
                ...
                \begin{tikzpicture}[scale=1.5]
                            \begin{axis}[
                                legend style={font=\tiny},
                                legend style={at={(0.03,1)},anchor=west},
                                xlabel= {Lattice Spacing $a$},
                                ylabel style ={rotate=0},
                                ylabel= {Energy},
                                enlargelimits=true,
            ...
            Plots of the density functions for the discrete and continuum cases are shown in figure \ref{fig:HarmonicWaveFunction} along with the simulation results at the given parameters. There is a divergence from the continuum result which is due to the finite lattice spacing of $a=1$ in this simulation. As $a\rightarrow 0$ the discrete theory and simulation results will converge on the continuum ground state density function.
                \begin{figure}
                    ...
                    \begin{tikzpicture}[scale=1.5]
                        ...
                        \end{axis}
                    \end{tikzpicture}
                    \caption{Continuum, discrete and measured ground state density functions for the harmonic oscillator with $\mu^2 = 1, m = 1$ on a lattice of $N=100$ sites at spacing $a = 1$.}
            ...
            \paragraph{Energy Levels}
                        ...
                        \begin{tikzpicture}[scale=0.7]
                            \begin{axis}[
                                ...
                                \addplot[only marks, 
                                    ...
                                    table[x index=0, 
                                        y index=1, 
                                        y error index=2]{DataForReport/AnharmonicCorrelationFunction.dat};
                            \end{axis}
                        \end{tikzpicture}
                        \caption{Correlation function.}
                        \label{fig:AnharmonicCorrelationFunction}
                    \end{subfigure}
                    \begin{subfigure}[b]{0.4\textwidth}
                        \begin{tikzpicture}[scale=0.7]
                            \begin{semilogyaxis}[
                ...
                \begin{figure}
                    ...
                    \begin{tikzpicture}[scale=1.5]
                        ...
                        \end{axis}
                    \end{tikzpicture}
                    \caption{Ground and first excited state energies for the anharmonic oscillator with $\lambda = 1, m = 1$ on a lattice of $N=1000$ sites at spacing $a = 0.1$. Values are shown for a range of $f^2$ values.}
    ...
    \begin{figure}
        ...
        \begin{figure}
                    ...
                    \end{tikzpicture}
                        ...
                        \vspace{4ex}
                    \end{subfigure}
                    \caption{Ground state density functions when varying $f^2$ for the simulations corresponding to figure \ref{fig:IntialFinalConfigurations}.}
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \begin{tikzpicture}[scale=1.2]
                        ...
                        \label{fig:TemperingEvolution1HAM}
  \end{subfigure}%% 
...
\end{figure}
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \begin{tikzpicture}[scale=1.2]
                        ...
                        \end{tikzpicture}
                        \caption{Evolution of the configuration with initial configuration in \textcolor{green}{green}, the configuration after $100$ leapfrog steps in \textcolor{red}{red} and at the end of the trajectory (the proposal configuration) in \textcolor{blue}{blue}.}
                        \label{fig:TemperingEvolution2CONF}
  \end{subfigure} 
  \caption{Evolution of Hamiltonian and configuration along leapfrog trajectory for tempering parameter $\alpha=1.01$}
...
\end{figure}
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \begin{tikzpicture}[scale=1.2]
                        ...
                        \end{tikzpicture}
                        \caption{Evolution of Hamiltonian along the leapfrog trajectory.}
                        \label{fig:TemperingEvolution3HAM}
  \end{subfigure}%% 
...
\section{Simulation Code}
    ...
    \lstinputlisting[language=C++]{../HMC-Oscillator/src/main.cpp}
